...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
	return function (dispatch) {
		return (0, _api_util.fetchSearchGiphysUtil)(searchTerm).then(function (giphys) {
...
var fetchSearchGiphysUtil = exports.fetchSearchGiphysUtil = function fetchSearchGiphysUtil(searchTerm) {
  return $.ajax({
    method: 'GET',
